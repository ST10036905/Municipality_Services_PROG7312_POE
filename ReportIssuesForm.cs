...
//Class used to manipulate the report issues form
    ...
    namespace Municipality_Services_PROG7321_POE
    {
            ...
            private Dictionary<string, string> estimatedTimes = new Dictionary<string, string>()
        {
            ...
            private void submitBtn_Click_1(object sender, EventArgs e)
            {
                try
                {
                    ...
                    newReport = new ReportData
                    {
                        ...
                        Category = categoryListBox.SelectedItem?.ToString() ?? string.Empty,
                ...
                // Displaying success message with report id
                MessageBox.Show($"Report submitted successfully! Your Request ID is: {uniqueID} \n" +
                    $"Copy to clipboard to be able to track status of request. ", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            /// <param name="sender"></param>
            /// <param name="e"></param>
            private void issuesRichTxtBox_TextChanged_1(object sender, EventArgs e)
            {
                ProgressBarUpdate();
            }//__________________________________________________________________________________________________________
